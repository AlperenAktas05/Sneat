            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="{{route("dashboard")}}" class="menu-link">
                        ...
                        <div data-i18n="Analytics">Görevler</div>
                    </a>
                </li>

                <!-- Layouts -->
                <li class="menu-item">
                    <a href="{{route("categoriesPage")}}" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Hesap Ayarları</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Authentications">Doğrulama</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="cards-basic.html" class="menu-link">
                        ...
                        <div data-i18n="Basic">Kartlar</div>
                    </a>
                </li>
                <!-- User interface -->
                <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="User interface">Kullanıcı Arayüzü</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Extended UI">Genişletilmiş UI</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="icons-boxicons.html" class="menu-link">
                        ...
                        <div data-i18n="Boxicons">Kutu Simgeleri</div>
                    </a>
                </li>

                <!-- Forms & Tables -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Formlar &amp; Tablolar</span></li>
                <!-- Forms -->
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-detail"></i>
                        <div data-i18n="Form Elements">Form Elementleri</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons bx bx-detail"></i>
                        <div data-i18n="Form Layouts">Form Düzenleri</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="tables-basic.html" class="menu-link">
                        ...
                        <div data-i18n="Tables">Tablolar</div>
                    </a>
                </li>
                <!-- Misc -->
                <li class="menu-header small text-uppercase"><span class="menu-header-text">Diğer</span></li>
                <li class="menu-item">
                    <a
                ...
                <li class="menu-item">
                    ...
                    >
                        ...
                        <div data-i18n="Documentation">Dökümantasyon</div>
                    </a>
                </li>
            </ul>
        </aside>
                ...
                <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <span class="d-flex align-items-center align-middle">
                          ...
                          <span class="flex-grow-1 align-middle">Ödeme</span>
